<template>
  <div class="header">
    <div class="content-wrapper">
      ...
      <div class="support-count" @click="isshow = true" v-if="seller.supports">
        <span class="count">{{seller.supports.length}}个</span>
        <i class="icon-keyboard_arrow_right"></i>
      </div>
    </div>
    <div class="bulletin-wrapper" @click="isshow = true">
    ...
    <transition name="fade">
      <div class="detail" v-show="isshow" >
        ...
        <div class="detail-close icon-close" @click="isshow = false"></div>
      </div>
    </transition>
  </div>
</template>
